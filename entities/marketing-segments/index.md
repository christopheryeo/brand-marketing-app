---
type: domain-index
domain: Marketing Segments
subtype: marketing-segment
status: active
...
**Purpose:** Defined audience groups used to classify and select campaign recipients.

**Domain type:** Entity
**Note subtype:** `marketing-segment`
...
```md
---
{"entityType":"marketing-segment","marketingSegmentId":"<stable-id>","name":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

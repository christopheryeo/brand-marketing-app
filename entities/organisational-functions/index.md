---
type: domain-index
domain: Organisational Functions
subtype: organisational-function
status: active
...
**Purpose:** Controlled organisational functions such as Marketing, Finance, HR, Sales and Management.

**Domain type:** Entity
**Note subtype:** `organisational-function`
...
```md
---
{"entityType":"organisational-function","functionId":"<stable-id>","name":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

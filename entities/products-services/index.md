...
**Purpose:** Reusable offerings provided by an organisation to customers or stakeholders.

**Domain type:** Entity
**Note subtype:** `product-service`
...
```md
---
{"entityType":"product-service","productServiceId":"<stable-id>","name":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

...
**Purpose:** Canonical records for companies, institutions, agencies, associations and business units.

**Domain type:** Entity
**Note subtype:** `organisation`
...
```md
---
{"entityType":"organisation","organisationId":"<stable-id>","name":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

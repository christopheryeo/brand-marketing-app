---
type: domain-index
domain: Sales Opportunities
subtype: sales-opportunity
status: active
...
**Purpose:** Potential commercial engagements with prospects, offerings, stages and expected outcomes.

**Domain type:** Entity
**Note subtype:** `sales-opportunity`
...
```md
---
{"entityType":"sales-opportunity","opportunityId":"<stable-id>","name":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

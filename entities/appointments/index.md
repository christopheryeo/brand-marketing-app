...
**Purpose:** Current and historical positions held by people within organisations.

**Domain type:** Entity
**Note subtype:** `appointment`
...
```md
---
{"entityType":"appointment","appointmentId":"<stable-id>","title":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

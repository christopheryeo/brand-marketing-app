...
**Purpose:** Controlled business-sector classifications used across organisations and activities.

**Domain type:** Entity
**Note subtype:** `industry`
...
```md
---
{"entityType":"industry","industryId":"<stable-id>","name":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---

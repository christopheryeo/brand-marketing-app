...
**Purpose:** Scheduled meetings, calls, webinars, conferences, demonstrations and business events.

**Domain type:** Entity
**Note subtype:** `meeting-event`
...
```md
---
{"entityType":"meeting-event","meetingEventId":"<stable-id>","title":"<name>","createdAt":"<SGT timestamp>","updatedAt":"<SGT timestamp>","status":"active","aliases":[],"tags":[],"confidence":1.0,"sourceRefs":[]}
---
